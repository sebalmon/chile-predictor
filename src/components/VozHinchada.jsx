// src/components/VozHinchada.jsx  — v8 (Bugfix 1)
// ─────────────────────────────────────────────────────────────
// BUG 2 CORREGIDO:
//   Antes: todos los emoticones visibles en fila siempre.
//   Ahora: solo se muestra el emoji que el usuario ya puso
//          (o un botón "＋" si no puso ninguno).
//          Al clicar aparece un popover con los 6 opciones.
...
function Reacciones({ docId, miUid }) {
  ...
  return (
    <div style={{ marginTop:"5px", display:"flex", alignItems:"center",
      gap:"4px", flexWrap:"wrap", position:"relative" }}>

      {/* Botón principal: emoji activo o "+" */}
