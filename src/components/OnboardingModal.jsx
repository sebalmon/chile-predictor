      ...
      contenido: (
        <>
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "4px" }}>
            ...
            <p style={{ fontSize: "6.5px", lineHeight: 2, margin: 0 }}>
              🏆 <span style={{ color: "var(--verde-claro)" }}>Ranking continuo:</span> Esta es una competencia por puntos de largo aliento. No hay cortes drásticos: acumulas todo el puntaje posible hasta el final del Mundial para ganar.
            </p>
          </div>
        </>
      ),
