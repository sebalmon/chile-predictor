// src/components/ModalPerfilCompleto.jsx
...
export default function ModalPerfilCompleto({ usuario, onCerrar }) {
  ...
  // Obtener cartas desbloqueadas del usuario
  const cartasDesbloqueadas = usuario.cartasDesbloqueadas || [];
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          {usuario.avatarId ? (
            <AvatarAnimado avatarId={usuario.avatarId} size={96} />
          ) : (
        ...
        {/* Datos personales */}
        <div style={{ textAlign: "center", borderBottom: "2px solid var(--verde-campo)", paddingBottom: "12px" }}>
          <p style={{ fontSize: "12px", color: "var(--amarillo)", marginBottom: "6px" }}>
            {usuario.nickname}
          </p>
          <p style={{ fontSize: "7px", color: "var(--gris-claro)" }}>
            {usuario.nombreReal || "Sin nombre real"}
          </p>
          <p style={{ fontSize: "6px", color: "var(--gris)" }}>
        ...
        <div>
          ...
          {cartasInfo.length === 0 ? (
            <p style={{ fontSize: "6px", color: "var(--gris-claro)", textAlign: "center" }}>
              No tiene cartas aún.
            </p>
          ) : (
